...
function createApp(options = {}) {
    ...
    function metricsText() {
        ...
        g('signin_outbox_depth', 'Off-site snapshots still waiting to be sent (mirror + SharePoint)', store.outboxDepth());
    ...
    return { handle, store, cfg, flushOutbox, roster, rosterText, metricsText, localDayStart, fireStart, sharepoint, hasOutboxSink, close: () => store.close() };
}
